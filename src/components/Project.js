...
const Projects = () => {
  ...
  return (
    <div className="bg-white md:mx-5 rounded-md py-8">
      <h2 className="text-blue-500 font-bold text-[28px] text-center pt-5 pb-2">
        RECENT WORKS
      </h2>
      <p
      ...
      <div className="mx-auto max-w-2xl py-10 px-4 sm:py-10 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div
          className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-1 md:grid-cols-2
      ...
      <div className="flex justify-center items-center max-w-xl mx-auto">
        <NavLink
          to="/projects"
          className="border border-deepBlue font-bold text-white
            flex-grow p-4 text-center
            rounded-md bg-paleBlue hover:opacity-90 active:bg-deepBlue sm:mx-7 xsm:mx-7"
        >
          View all
        </NavLink>
      </div>
